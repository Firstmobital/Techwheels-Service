  ...
  const renderActions = (slot: CustomerClaimDocumentDef) => (
    <View style={{ flexDirection: 'row', gap: 8, marginTop: 10 }}>
      <TouchableOpacity
        ...
        style={{ flex: 1, backgroundColor: CustomerTheme.teal, borderRadius: 12, paddingVertical: 12, alignItems: 'center' }}
      >
      ...
      <CustomerCard key={slot.docKey} style={{ marginBottom: 12, padding: 16 }}>
        ...
        {busy ? (
          <View style={{ marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            <ActivityIndicator color={CustomerTheme.teal} />
        ...
        {submitted && row ? (
          <TouchableOpacity onPress={() => void openRow(row)} style={{ marginTop: 12 }}>
            ...
            <Text style={{ color: CustomerTheme.teal, fontSize: 11, marginTop: 2, fontWeight: '700' }}>Open Drive file</Text>
          </TouchableOpacity>
        ) : null}
        ...
        {pending && row && !busy ? (
          <View style={{ marginTop: 12 }}>
            ...
            <TouchableOpacity
              ...
              style={{ marginTop: 8, alignSelf: 'flex-start', backgroundColor: CustomerTheme.navyDeep, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8 }}
            >
      ...
      {!loading && claimMode === 'insurance' ? (
        <CustomerCard>
          ...
          <View style={{ height: 8, borderRadius: 999, backgroundColor: '#E2E8F0', marginTop: 10, overflow: 'hidden' }}>
            <View style={{ width: `${progressPercent}%`, height: '100%', backgroundColor: progressPercent === 100 ? CustomerTheme.success : CustomerTheme.teal }} />
          </View>
