...
| DBL-0004 | 2026-05-23 | Tighten RLS for import/parts tables by replacing permissive anon policies with module-aware authenticated policies | rls | supabase/migrations/20260523143000_phase33_tighten_parts_import_rls.sql | GitHub Copilot | Techwheels Admin + Dev Team | PROPOSED | N/A | Initial SQL Editor run hit upstream timeout; added lock-safe retry migration supabase/migrations/20260523153000_phase33_tighten_parts_import_rls_locksafe_retry.sql and paired checks supabase/sql_checks/20260523153000_phase33_tighten_parts_import_rls_locksafe_retry_checks.sql | local_folder/backups/full_database.sql |
