...
- [ONBOARDING_POLICY.md](../reference/ONBOARDING_POLICY.md) — Onboarding behavior decision
- [MODULE_ROUTE_CONTRACT.md](../reference/MODULE_ROUTE_CONTRACT.md) — Route definitions
