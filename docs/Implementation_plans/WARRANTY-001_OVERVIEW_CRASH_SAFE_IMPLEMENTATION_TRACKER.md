...
| A14 | FSB service-type decomposition wiring | Copilot | DONE | 2026-06-04 | 2026-06-04 | Wired to DB source_row_data service_type field | Added serviceType field to WarrantyRecord; categoryCounts now decomposes FSB into 4 stype rows (1st/2nd/3rd/4th Free Service); computedClaimTypeRows fetches actual FSB data grouped by stype instead of placeholder empty arrays; both Claims by source and Claim-type performance cards now show FSB decomposition |
| A11 | Regression pass (filters/location/fuel role scope) | Copilot | TODO | - | - | - | Ensure no breakage |
