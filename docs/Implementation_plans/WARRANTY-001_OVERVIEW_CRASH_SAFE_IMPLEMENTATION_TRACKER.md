...
| A14 | FSB service-type decomposition wiring | Copilot | DONE | 2026-06-04 | 2026-06-04 | Wired to DB + both cards show decomp | Added serviceType field to WarrantyRecord; categoryCounts decomposes FSB into 4 stype rows (1st/2nd/3rd/4th Free Service) shown in Claims by source bar chart; computedClaimTypeRows fetches actual FSB data grouped by stype with settlement/rejection stats shown in Claim-type table |
