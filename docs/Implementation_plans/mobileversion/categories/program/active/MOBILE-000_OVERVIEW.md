...
1. Master program tracker (single execution authority): `docs/Implementation_plans/mobileversion/categories/program/active/MOBILE-010_MOBILE_PROGRAM_MASTER_TRACKER.md`
2. Strategy baseline: `docs/Implementation_plans/mobileversion/categories/program/active/MOBILE-001_EXPO_IMPLEMENTATION_PLAN.md`
