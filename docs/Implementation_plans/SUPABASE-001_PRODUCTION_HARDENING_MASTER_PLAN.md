...
| P0-04 | High | Restrict `anon` API key permissions in settings | Team | In Progress | 2026-06-08 |  | Dashboard-only attempt produced no delta (`25/322/31`). DB-level unblock migration/check artifacts prepared: `supabase/migrations/20260608182000_p0_04_restrict_anon_public_surface.sql`, `supabase/sql_checks/20260608182000_p0_04_restrict_anon_public_surface_checks.sql`. | 2026-06-08 | Execute P0-04 migration in SQL Editor, run post-migration checks, then run web/mobile auth smoke tests |
