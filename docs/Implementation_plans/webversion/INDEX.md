...
|---|---|---|---|---|
| ACCOUNTS-001 | accounts | Active (DBL-0060 DMS invoice-date voucher fallback) | Accounts + Platform Team | `docs/Implementation_plans/webversion/categories/accounts/active/ACCOUNTS-001_MECHANICAL_BODYSHOP_ACCOUNTS_DESK_PLAN_2026-09-11.md` |
