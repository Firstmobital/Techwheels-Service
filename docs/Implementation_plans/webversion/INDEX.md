...
|---|---|---|---|---|
| ACCOUNTS-001 | accounts | Active (DBL-0061 APPLIED Mechanical Gatepass 2% / Keep on Credit / overpay) | Accounts + Platform Team | `docs/Implementation_plans/webversion/categories/accounts/active/ACCOUNTS-001_MECHANICAL_BODYSHOP_ACCOUNTS_DESK_PLAN_2026-09-11.md` |
...
| PARTS-002 | parts | In progress (DBL-0062 VERIFIED; Phase 1b Make BS4/BS6 DBL-0063; SA Create Estimate = Phase 5 / DBL-0064 later) | Parts Team + Platform Team | `docs/Implementation_plans/webversion/categories/parts/active/PARTS-002_ESTIMATE_PARTS_MASTER_UNIQUE_ID_AND_DB_TRUTH_PLAN_2026-09-15.md` |
...
| parts | `docs/Implementation_plans/webversion/categories/parts/evidence/PARTS-002_TEST_MATRIX.md` |
