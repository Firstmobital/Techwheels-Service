...
2. Customer portal completion
  ...
  - Formal scripted E2E artifact consolidated into existing guide: `docs/complaints/reference/COMPLAINTS_TEST_EXECUTION_GUIDE.md` (Part 5: Mint -> Raise -> Track -> Reopen).
