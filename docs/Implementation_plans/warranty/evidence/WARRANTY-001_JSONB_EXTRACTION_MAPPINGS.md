...
- Implementation plan: `docs/Implementation_plans/warranty/active/WARRANTY-001_WARRANTY_REPORT_IMPORT_AND_REPORTING_PLAN.md` (TR-024..TR-042)
...
1. **Every TR task execution must:**
   ...
   - Update master tracker simultaneously: `docs/Implementation_plans/redesign/active/Webredesign_IMPLEMENTATION_PLAN_MASTER_TRACKER.md`
