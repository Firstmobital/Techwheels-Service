...
| C7 | 0.260 / 0.259 / 0.235 | `docs/shared/runbooks/ONBOARDING_GATING_ENFORCEMENT.md` vs RBAC evidence docs | Domain-specific evidence files in `docs/rbac/evidence/` | Left intact; conceptual adjacency is expected but documents serve different workflows | Accepted |
