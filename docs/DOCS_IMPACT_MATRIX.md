...
| DB governance/tracking updates | `docs/shared/reference/DB_CHANGE_LEDGER.md`, `docs/shared/reference/DB_CHANGE_PROTOCOL.md`, `docs/Implementation_plans/*` | `SYNC_PROTOCOL.md`, `CURRENT_STATE.md`, `CHANGE_LOG.md`, relevant implementation plan index |
