...
### For QA Team (Testing)
1. Read [RBAC_ROLE_MATRIX_TESTING.md](docs/RBAC_ROLE_MATRIX_TESTING.md) — Execute role matrix tests
2. Read [RBAC_SECURITY_TESTING.md](docs/RBAC_SECURITY_TESTING.md) — Execute security tests
3. Read [RBAC_TABLE_ACCESS_VALIDATION_TESTS.md](docs/RBAC_TABLE_ACCESS_VALIDATION_TESTS.md) — Validate backend

### For Operations Team (Rollout & Maintenance)
1. Read [RBAC_OPERATIONS_RUNBOOK.md](docs/RBAC_OPERATIONS_RUNBOOK.md) — Learn all procedures
2. Bookmark quick reference table at top
3. Check [RBAC-001_DAILY_STANDUP_CHECKLIST.md](docs/Implementation_plans/RBAC-001_DAILY_STANDUP_CHECKLIST.md) — Daily tracking

### For Engineering (Reference)
1. Read [MODULE_ROUTE_CONTRACT.md](docs/Project_Handbook/MODULE_ROUTE_CONTRACT.md) — Understand module-route mapping
2. Read [ROUTE_STRATEGY_DECISION.md](docs/Project_Handbook/ROUTE_STRATEGY_DECISION.md) — Understand design decision
3. Read [ONBOARDING_POLICY.md](docs/Project_Handbook/ONBOARDING_POLICY.md) — Understand new user behavior
...
**Related Plan:** [RBAC-001_DYNAMIC_RBAC_AND_MODULE_WIRING.md](docs/Implementation_plans/RBAC-001_DYNAMIC_RBAC_AND_MODULE_WIRING.md)
