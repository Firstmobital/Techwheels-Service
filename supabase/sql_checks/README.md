...
Purpose: Keep read-only post-migration verification scripts paired with each migration.
...
Check file:
- supabase/sql_checks/20260523120000_add_module_permission_helper_functions_checks.sql
