...
-- Purpose: Remove permissive fallback for assumed_next_service_type and use 'Unknown' for unmapped last_service_type values.
...
IS 'Maps known last_service_type values to assumed_next_service_type. Unknown/non-standard non-blank values map to ''Unknown'' (no permissive fallback). Blank remains NULL.';

-- Recompute existing rows under strict Unknown policy.
