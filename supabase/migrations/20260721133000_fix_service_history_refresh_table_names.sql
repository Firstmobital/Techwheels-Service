-- refresh_all_service_data_from_service_history referenced quoted mixed-case
-- relation names ("EV_service_history_test" / "PV_service_history_test") while
-- the live tables are public.ev_service_history_test and public.pv_service_history_test.
-- pg_cron queue processing failed with SQLSTATE 42P01 on the EV name.
