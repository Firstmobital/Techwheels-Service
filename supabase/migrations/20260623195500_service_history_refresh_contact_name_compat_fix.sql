-- Hotfix: make Service-History refresh compatible with contact name column drift
-- (`contact_full_name` vs historical typo `conatct_full_name`).
...
'Refreshes all_service_data from Service-History test sources with contact-name compatibility (`contact_full_name` / `conatct_full_name`).';
