-- Align customer app bodyshop stage with web BodyshopRepairPage (worklist projection + RI clamp).
...
begin
  ...
  select
    ...
    || jsonb_build_object(
      ...
      'customer_effective_stage_name', case v_effective
...
revoke all on function public.customer_bodyshop_effective_stage(public.bodyshop_repair_cards) from public;
