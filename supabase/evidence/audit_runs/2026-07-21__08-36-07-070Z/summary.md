# Supabase Audit Cycle Summary (2026-07-21T08:36:07.070Z)

- Project ref: jmdndcphkmaljhwgzqxq
- Capture mode: automated_supabase_audit_cycle
- Top query summary: Top query -2876120296317350531 calls=426139 total_ms=4158983.78 mean_ms=9.76

## Query Performance (Top 10)

| queryid | calls | total_ms | mean_ms |
|---|---:|---:|---:|
| -2876120296317350531 | 426139 | 4158983.78 | 9.76 |
...
| -8535248155740750540 | 121 | 661036.12 | 5463.11 |
...
- Previous run: 2026-07-21__08-32-26-944Z
...
- delta_total_ms_sum: 109747.54

## DB Health

- postgres: commits=8765853, rollbacks=879584, blks_hit_ratio_pct=99.99, deadlocks=2
...
- total_connections=26, active_connections=9, idle_connections=15, waiting_connections=17, max_connections=60

## Postgres Log Severity (Recent)

- error=1, warning=0, fatal=0, panic=0, total_records=2

## Top Postgres Errors & Warnings (Ranked by Frequency)

| # | occurrences | event_message |
|---|---:|---|
| 1 | 1 | canceling statement due to statement timeout |
