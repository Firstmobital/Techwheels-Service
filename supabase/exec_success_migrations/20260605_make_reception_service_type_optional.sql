...
-- Step 1: Drop the old constraint that requires service_type to be non-blank
ALTER TABLE public.service_reception_entries
  DROP CONSTRAINT service_reception_service_type_not_blank;

-- Step 2: Make service_type nullable (change from NOT NULL to nullable)
ALTER TABLE public.service_reception_entries
  ALTER COLUMN service_type DROP NOT NULL;

-- Step 3: Add new constraint that allows NULL but disallows blank strings when present
ALTER TABLE public.service_reception_entries
