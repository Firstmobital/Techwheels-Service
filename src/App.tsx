...
const NAV_ITEMS = [
  ...
  { to: '/busy', label: 'BUSY', icon: 'banknote' },
  { to: '/accounts', label: 'Accounts', icon: 'reports' },
...
const ROUTE_MODULE_MAP: Record<AppRoute, ModuleName[]> = {
  ...
  '/driver-management': ['service_booking', 'driver_management', 'admin', 'reception'],
  '/wa-agent': ['wa_agent'],
            ...
            {!defaultRoute ? (
              ...
              <Routes>
                ...
                <Route
                  path="/busy"
                  element={(
                    <RequireAccess allowedModules={allowedModules} modules={ROUTE_MODULE_MAP['/busy']}>
                      <BusyAccountingPage />
                    </RequireAccess>
                  )}
                />
                <Route
                  path="/accounts"
                  element={(
                    <RequireAccess allowedModules={allowedModules} modules={ROUTE_MODULE_MAP['/accounts']}>
                      <AccountsPage />
                    </RequireAccess>
                  )}
                />
